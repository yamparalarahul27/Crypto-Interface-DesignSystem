...
/**
 * Segmented theme switch (all [data-theme] value-sets). Stamps
 * <html data-theme> and persists.
 *
 * `variant="swatch"` renders each theme as a color circle instead of its
 * name: the circle is scoped with data-theme={t}, so the CSS variables
 * inside it resolve to THAT theme's values regardless of the page theme —
 * the swatches are the token system previewing itself, not a hardcoded
 * palette (globals.css aliases [data-theme="dark"] to :root for this).
 */
